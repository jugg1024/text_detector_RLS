...
lib_src{end+1} = fullfile(root,'matlab','src',['gconv.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src',['gnormalize.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src',['gpool.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src',['gsepconv.' ext]) ;
lib_src{end+1} = fullfile(root,'matlab','src',['gsepconv2.' ext]) ;


% CPU-specific files
lib_src{end+1} = fullfile(root,'matlab','src','bits','im2row_cpu.cpp') ;
lib_src{end+1} = fullfile(root,'matlab','src','bits','pooling.cpp') ;
lib_src{end+1} = fullfile(root,'matlab','src','bits','normalize.cpp') ;

% GPU-specific files
if opts.enableGpu
  lib_src{end+1} = fullfile(root,'matlab','src','bits','im2row_gpu.cu') ;
